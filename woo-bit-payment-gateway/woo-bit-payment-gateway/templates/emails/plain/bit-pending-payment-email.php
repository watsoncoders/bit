...
echo sprintf( esc_html__( 'Hi %s,', 'woo-bit-payment-gateway' ), esc_html( $order->get_billing_first_name() ) ) . "\n\n";
/* translators: %s: Order number */
echo sprintf( esc_html__( 'Just to let you know — your order has been received for order number #%s.', 'woo-bit-payment-gateway' ), esc_html( $order->get_order_number() ) ) . "\n\n";
echo esc_html__( $instruction );
echo sprintf( esc_html__( 'Bit Phone Number: ', 'woo-bit-payment-gateway' ));
